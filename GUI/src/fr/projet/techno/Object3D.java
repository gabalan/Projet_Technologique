...
import fr.projet.techno.common.ResourceRetriever;
...
public class Object3D {
    ...
    public void castShadow(GL2 gl, float[] lp) {
        Point v1 = new Point();
        Point v2 = new Point();
        ...
        gl.glStencilFunc(GL2.GL_ALWAYS, 1, 0xffffffff);
        ...
        gl.glStencilFunc(GL2.GL_NOTEQUAL, 0, 0xffffffff);
